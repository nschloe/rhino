...
import sys
from scipy.sparse.linalg import cg, bicgstab, gmres, LinearOperator
...
def _main():
    ...
    _run_different_meshes( ginla_modelval, precs )

    #print "Solving the system without preconditioning, scipy cg..."
    #sol, info, relresvec0 = nm.cg_wrap( ginla_modelval._keo, rhs,
                                        #x0 = psi0,
                                        #tol = 1.0e-10,
                                        #maxiter = 1000,
                                        #M = None
...
def _run_different_meshes( ginla_modelval,
    ...
    for mesh_file in mesh_files:
        ...
        relresvecs = _run_preconditioners( ginla_modelval._keo,
                                           rhs,
                                           psi0,
